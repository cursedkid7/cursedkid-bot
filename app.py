...
def handle_sold(chat_id, args, reply_to_message_id=None):
    if not reply_to_message_id:
        send_message(chat_id, "❌ Reply to an account message with /sold [price]\nExample: Reply to account with /sold 250")
        return
    
    if len(args) < 1:
        send_message(chat_id, "❌ Please specify price\nExample: /sold 250")
        return
    ...
    send_message(chat_id, "📌 Please provide the Account ID to mark as sold.\nUse /sold [price] [id]\nExample: /sold 250 1")
